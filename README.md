...
Example 2: POST Create a New User
Request Type: POST
URL: http://localhost:3000/api/users
Body:
json
...
Example 7: PUT Update a Thought
Request Type: PUT
...
Example 8: DELETE a Thought
Request Type: DELETE
URL: http://localhost:3000/api/thoughts/<thoughtId> (replace <thoughtId> with the actual thought ID)
Send Request: Click Send to delete the thought.
Example 9: POST Add a Friend to a User
Create a New Friend:
...
Example 10: DELETE Remove a Friend from a User
Request Type: DELETE
